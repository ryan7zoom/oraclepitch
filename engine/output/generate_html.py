...
def generate_html(predictions: list[dict], generated_at: Optional[datetime] = None) -> str:
...
<body>
<header>
  <h1>EPL Prediction Dashboard</h1>
  <div class="meta">Generated: {timestamp_str} &middot; Data: API-Football</div>
</header>
...
<footer>
  Corners predictions are currently disabled pending a reliable data source.
...
def write_html(predictions: list[dict], output_path: str = None):
